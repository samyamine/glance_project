...
export default function Header() {
    return (
        <div className={`w-full h-24 px-4 md:px-16 lg:px-24 fixed top-0 flex justify-center bg-white z-40`}>
        ...
        // <div className={`w-full h-24 md:px-16 lg:px-24 fixed top-0 flex justify-between items-center bg-white z-40`}>
        //     <Link href={`/`}>
        //         <Image src={`/logos/logo_1.svg`} alt={`Glance`} width={180} height={1} />
        //     </Link>
        //
