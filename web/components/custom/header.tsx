...
import BurgerButton from "@/components/custom/burgerButton";
import {useState} from "react";

// export default function Header() {
//     return (
//         <div className={`w-full h-20 md:h-24 px-4 md:px-16 lg:px-24 fixed top-0 flex justify-center  z-40 bg-red-300`}>
//         {/*<div className={`w-full h-20 md:h-24 px-4 md:px-16 lg:px-24 fixed top-0 flex justify-center z-40`}>*/}
//             <div className={`bg-orange-200 w-full h-full max-w-[1440px] flex justify-between items-center`}>
//                 <div className={`w-full md:hidden`}>
//                     <BurgerButton />
//                 </div>
//                 <Link href={`/`} className={`max-md:absolute max-md:left-1/2 max-md:-translate-x-1/2`}>
